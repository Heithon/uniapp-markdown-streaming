...
<template>
  <view class="gj__markdown">
    <view
      class="gj-markdown-wrapper"
      :source="source"
...
export default {
  ...
  methods: {
    /**
     * 设置目标md元素
     * @param {string} newId - 新的目标md元素ID
     * @param {string} oldId - 旧的目标md元素ID
     * @param {object} ownerVm - 所有者组件实例
    ...
    /**
     * 更新源文本
     * @param {string} newSource - 新的源文本
     * @param {string} oldSource - 旧的源文本
     * @param {object} ownerVm - 所有者组件实例
     * @param {object} vm - 当前组件实例
     */
    ...
    /**
     * 更新显示行号
     * @param {string} newShowLine - 新的显示行号
     * @param {string} oldShowLine - 旧的显示行号
     * @param {object} ownerVm - 所有者组件实例
     * @param {object} vm - 当前组件实例
     */
    ...
    renderContent() {
      ...
      if (!this.currentSource && this.targetMdElement) {
        this.targetMdElement.innerHTML = "";
        return;
      }

      this.copyCodeData = []; // 重置复制数据
      let value = this.currentSource;
