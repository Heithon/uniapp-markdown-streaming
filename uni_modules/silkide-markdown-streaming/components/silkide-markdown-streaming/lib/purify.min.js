...
!(function (e, t) {
  ...
  var re = (function t() {
    ...
    let ot = nt,
      rt = !1,
      it = null;
    const at = R({}, [et, tt, nt], g);
    let lt = R({}, ["mi", "mo", "mn", "ms", "mtext"]),
      ct = R({}, ["annotation-xml"]);
    const st = R({}, ["title", "style", "font", "a", "script"]);
    let ut = null;
      ...
      gt = function () {
        ...
        if (!ft || ft !== e) {
          if (
            ...
            (Ne = _(e, "ALLOWED_TAGS") ? R({}, e.ALLOWED_TAGS, pt) : we),
            (Re = _(e, "ALLOWED_ATTR") ? R({}, e.ALLOWED_ATTR, pt) : Oe),
            (it = _(e, "ALLOWED_NAMESPACES")
              ? R({}, e.ALLOWED_NAMESPACES, g)
              : at),
            (Je = _(e, "ADD_URI_SAFE_ATTR")
              ? R(v(Qe), e.ADD_URI_SAFE_ATTR, pt)
              : Qe),
            (Ve = _(e, "ADD_DATA_URI_TAGS")
              ? R(v(Ze), e.ADD_DATA_URI_TAGS, pt)
              : Ze),
            ($e = _(e, "FORBID_CONTENTS") ? R({}, e.FORBID_CONTENTS, pt) : Ke),
            (De = _(e, "FORBID_TAGS") ? R({}, e.FORBID_TAGS, pt) : v({})),
            (xe = _(e, "FORBID_ATTR") ? R({}, e.FORBID_ATTR, pt) : v({})),
            ...
            qe &&
              ((Ne = R({}, U)),
              (Re = []),
              !0 === qe.html && (R(Ne, x), R(Re, z)),
              !0 === qe.svg && (R(Ne, L), R(Re, P), R(Re, F)),
              !0 === qe.svgFilters && (R(Ne, C), R(Re, P), R(Re, F)),
              !0 === qe.mathMl && (R(Ne, I), R(Re, H), R(Re, F))),
            e.ADD_TAGS && (Ne === we && (Ne = v(Ne)), R(Ne, e.ADD_TAGS, pt)),
            e.ADD_ATTR && (Re === Oe && (Re = v(Re)), R(Re, e.ADD_ATTR, pt)),
            e.ADD_URI_SAFE_ATTR && R(Je, e.ADD_URI_SAFE_ATTR, pt),
            e.FORBID_CONTENTS &&
              ($e === Ke && ($e = v($e)), R($e, e.FORBID_CONTENTS, pt)),
            je && (Ne["#text"] = !0),
            ze && R(Ne, ["html", "head", "body"]),
            Ne.table && (R(Ne, ["tbody"]), delete De.tbody),
    ...
    const Rt = function (e) {
        ...
        if (
          (wt(de.uponSanitizeElement, e, { tagName: n, allowedTags: Ne }),
          Ue &&
            e.hasChildNodes() &&
        ...
        if (!Ne[n] || De[n]) {
          if (!De[n] && vt(n)) {
            if (ve.tagNameCheck instanceof RegExp && S(ve.tagNameCheck, n))
              return !1;
            if (ve.tagNameCheck instanceof Function && ve.tagNameCheck(n))
              return !1;
          }
          if (je && !$e[n]) {
        ...
        return e instanceof O &&
          ...
          ? (Me &&
              ...
              e.textContent !== t &&
                ...
                (e.textContent = t))),
            wt(de.afterSanitizeElements, e, null),
            !1)
          : (Et(e), !0);
      },
      Ot = function (e, t, n) {
        ...
        if (Ce && !xe[t] && S(ye, t));
          ...
          if (
            !(
              (vt(e) &&
                ((ve.tagNameCheck instanceof RegExp && S(ve.tagNameCheck, e)) ||
                  (ve.tagNameCheck instanceof Function &&
                    ve.tagNameCheck(e))) &&
                ((ve.attributeNameCheck instanceof RegExp &&
                  S(ve.attributeNameCheck, t)) ||
                  (ve.attributeNameCheck instanceof Function &&
                    ve.attributeNameCheck(t, e)))) ||
              ("is" === t &&
                ve.allowCustomizedBuiltInElements &&
                ((ve.tagNameCheck instanceof RegExp && S(ve.tagNameCheck, n)) ||
      ...
      Dt = function (e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            wt(de.uponSanitizeAttribute, e, n),
            (f = n.attrValue),
            !Ye ||
              ("id" !== s && "name" !== s) ||
              (At(a, e), (f = "user-content-" + f)),
            Ue && S(/((--!?|])>)|<\/(style|title|textarea)/i, f))
          ) {
            At(a, e);
            continue;
          }
      ...
      xt = function e(t) {
        let n = null;
        const o = St(t);
        for (wt(de.beforeSanitizeShadowDOM, t, null); (n = o.nextNode()); )
          wt(de.uponSanitizeShadowNode, n, null),
            Rt(n),
            Dt(n),
    ...
    return (
      (o.sanitize = function (e) {
        ...
        const c = St(Xe ? e : n);
        for (; (i = c.nextNode()); )
          Rt(i), Dt(i), i.content instanceof s && xt(i.content);
        if (Xe) return e;
        if (Fe) {
          if (Be)
